  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0C1222] via-[#0F1628] to-[#131B30] text-gray-200 pt-24 flex items-center justify-center">
      ...
      >
        ...
        <Link 
          href="/"
          className="inline-block bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-medium py-3 px-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300"
        >
          Continue Shopping
        </Link>
      </motion.div>
